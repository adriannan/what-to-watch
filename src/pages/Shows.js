    ...
    <section className="section__tvshows">
      <div className="tvshows__header">
        ...
        <button className="tvshows__btn">
          Genres <i className="material-icons tvshows__btn-icon">arrow_drop_down</i>
        </button>
        <button className="tvshows__btn">
          Production
        ...
        <button className="tvshows__btn">
          Year <i className="material-icons tvshows__btn-icon">arrow_drop_down</i>
        </button>
        <button className="tvshows__btn">
          Rate <i className="material-icons tvshows__btn-icon">arrow_drop_down</i>
        </button>
        <button className="tvshows__btn">
          Sort by <i className="material-icons tvshows__btn-icon">arrow_drop_down</i>
        </button>
      </div>
